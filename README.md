...
solução: adição de todas as funcionalidadews.
...
solução por usar a api vi que não precisava e tambem vi que o problema era porque não estava tendo reprocessamento da tela pelo useEffect
...
solução: com muita tentativa conseguir resolver estava tendo dificuldade pois nunca tinha mexido com rest antes só sabia a teoria.

Status do Projeto: Concluido <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
